...
GRID_PATH     = os.environ["GRID"]
PREPNN_PATH   = os.environ["PREPNN"]
SPECGRID_PATH = os.environ["SPECGRID"]

SPECGRID_DATA_DIR  = os.path.join(ROOT, "test/testdata/testspecgriddata/")
PREPNN_DATA_DIR    = os.path.join(ROOT, "test/testdata/testprepnndata/")
STELLARNN_DATA_DIR = os.path.join(ROOT, "test/testdata/teststellarnndata/")
